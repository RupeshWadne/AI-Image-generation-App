...
const CreatePost = () => {
    ...
    const generateImage = async () => {
        if(form.prompt) {
            try {
                ...
                const response = await fetch('https://ai-image-app.onrender.com/api/v1/dalle', {
                    method: 'POST',
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if(form.prompt && form.photo) {
            ...
            try {
                const response = await fetch('https://ai-image-app.onrender.com/api/v1/post', {
                    method: 'POST',
                    headers: {
                        'Content-Type' : 'application/json',
                    },
    ...
    return (
        <section className="max-w-7xl mx-auto">
            ...
            <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                ...
                <div className="mt-10">
                    <p className="mt-2 text-[#666e75] text-[14px]">Once you have created the image youn want, you can share it with others in the community.</p>
                    <button
                        type="submit"
